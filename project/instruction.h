...
//    std::function<void(int64_t, int32_t, std::vector<std::shared_ptr<Argument>> vm_register)> implementation;
//
//    ~Instruction() {
//        name = "";
//        opcode = "";
...
//                                                                                  std::vector<std::shared_ptr<Argument>> vm_register) {
...
static std::vector<Instruction> instructions{{"mov",          "000",    "RR",  [](int64_t, int32_t,
                                                                                  std::vector<std::shared_ptr<Argument>> vm_register) {
                                                 vm_register[1].get()->value = vm_register[0].get()->value;
                                             }},
                                             {"add",          "010001", "RRR", [](int64_t, int32_t,
                                                                                  std::vector<std::shared_ptr<Argument>> vm_register) {
                                                 vm_register[2].get()->value =
                                                         vm_register[0].get()->value + vm_register[1].get()->value;
                                             }
                                             },
                                             {"sub",          "010010", "RRR", [](int64_t, int32_t,
                                                                                  std::vector<std::shared_ptr<Argument>> vm_register) {
                                             ...
                                             {"consoleWrite", "10011",  "R",   [](int64_t constant, int32_t,
                                                 ...
                                                 std::cout << std::hex << std::setw(16) << std::setfill('0')
                                                           << vm_register[0].get()->value << std::endl;
                                             }
                                             }
};
